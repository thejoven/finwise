...
| 账户净值卡 | 全 Phase: 财富密码 不是 trading platform |
...
5. 问自己 "财富密码 突然消失我会失去什么"——答 "看见自己的能力" → 产品成立
...
**为什么禁**: 财富密码 **不是** trading platform。M9 spec 明确写:
...
> 如果今天 财富密码 突然消失, 我会感到失去了什么?

如果答案是 "失去了我看见自己的能力"——产品成立, 财富密码 v1.0 完成。
