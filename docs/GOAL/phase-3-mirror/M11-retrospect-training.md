...
>
> **整个 GOAL 文档体系的最后一个模块**。完成它 = 财富密码 v1.0 完成。
...
## "终点"验收 · 财富密码 v1.0 成立的条件

W26 复盘结束, 我做一件事:

> 打开 APP, 看完时间轴, 答完四问, 看到训练重点。
> 然后问自己: **"这个训练重点, 是不是只有 财富密码 能告诉我?"**

如果答案是 "是" — 财富密码 v1.0 成立。
如果答案是 "其他工具也能" — 训练重点泛了, 重做 Diagnostician。

更深一层: **如果今天 财富密码 突然消失, 我会感到失去了什么?**
...
- 更新 `GOAL.md` § 5 当前进度到 W26 · **财富密码 v1.0 完成**
- 写一份"Phase 3 自用复盘"
