...
- **12 · 主动信号推荐 开发文档** ⚠️草案 — 用行为轨迹算出每用户 alpha 画像, 从订阅 firehose 策展极少数信号, 嵌入归档/承诺复盘; 红线=不做成 FOMO 推送流, 宁可不推
- **13 · 标的追踪 开发文档** 🚧 P0+P1 已落地 2026-06-16 / P2+ 草案 — 标的归一(迁移 025 + resolver + 回填)+ 行情底座(迁移 029 + marketdata 抽象, 默认腾讯源, A股日线从锚点回填日更)已成; 以"发现时刻"为冻结锚点展示发现后股价走势 + 点击标的进专页看全部相关命题 + 承诺表现(P2+); 为 12 提供客观地面真值
