...
- **12 · 主动信号推荐 开发计划** — 12 的执行版任务单: P0 已落地基线 + **P1「持仓相关情报」**工作包(迁移 025/漏斗/Mastra recommender/移动端/验收); P2+ 待排
- **13 · 标的追踪 开发文档** ⚠️草案 — 信号标的归一 + 行情源接入, 以"发现时刻"为冻结锚点展示发现后股价走势; 点击标的进专页看全部相关命题; 为 12 提供客观地面真值
