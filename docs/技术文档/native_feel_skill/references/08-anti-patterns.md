...
**为什么**:Alert 视觉无法控制, 跨平台样式不一致, 且和 Flashfi Engine 的设计语言冲突。
...
>
> Flashfi Engine 之所以是 Flashfi Engine, 一半在做了什么, 一半在没做什么。
