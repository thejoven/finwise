...
import { TapEffect } from "@/shared/components";
 ...
 *
 * 几何: 三段等宽 (flex:1), 段宽 segW 由 onLayout 量出存进共享值, 下划线落点 = progress×segW
 *   居中. 底部一道 hairline 收边 (与报头折叠态的收底线一脉相承, 分隔报头区与内容).
 *
 * 字体走 cjkBold 裸 RNText —— 与刊名「财知」/底栏标签同款, 属常驻 chrome (参 DynamicIslandTabBar).
 */
