 ...
 *
 * 题面与选项锚定 Flashfi Pro Lens (与 mastra/src/agents/lens.ts 一致):
...
export const RETROSPECT_QUESTIONS: RetrospectQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "second_one_lens", label: "二阶 · 单 lens · 谁因此被迫让步 (有二阶, 但只用了金融或商业)" },
      { id: "third_multi_lens", label: "三阶 · 多 lens · 跨学科 (法律 / 工程 / 博弈 / 历史) 交叉看到了反共识的赢家" },
      { id: "wavered", label: "中途自己说服自己回退了 — 链跑出来了, 但又自我否决" },
    ],
    openPrompt: "如果重来, 你会用哪个之前漏掉的 lens? (心理学 / 法律 / 历史 / 博弈论 / 生物学 / 工程 / 化学 / 物理 / 数学 中挑一个)",
  },
  {
    no: 3,
    dim: "evaluation",
    ...
    options: [
      ...
      { id: "wrong_kind", label: "错型 · 这个仓位本就不该用退出条件 (本质是 hedge / pair / 长期 own)" },
    ],
  ...
  },
  {
    ...
    openPrompt: "如果有犹豫, 你在反复检查的是哪个 lens? (是 base rate 不放心, 还是反身性时机判断, 还是别的)",
  },
];
