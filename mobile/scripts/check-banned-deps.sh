...
# Source of truth: docs/技术文档/native_feel_skill/references/05-alphax-restraint.md § 9
...
if [ "$found" -gt 0 ]; then
  ...
  echo "See docs/技术文档/native_feel_skill/references/05-alphax-restraint.md § 9 for the reasoning."
  exit 1
fi
